...
\newtcbox{\myTerminal}{enhanced,nobeforeafter,tcbox raise base,boxrule=0.5pt,top=0mm,bottom=0mm,
  ...
  colframe=RoyalBlue2,coltext=white,colback=black,
  overlay={\begin{tcbclipinterior}\fill[white] (frame.south west)
    rectangle node[text=RoyalBlue2,font=\sffamily\bfseries\tiny,rotate=0] {\faTerminal} ([xshift=6mm]frame.north west);\end{tcbclipinterior}}}
...
{\large \myDefinitionIcon Syllabus} \doublerulefill
...
\begin{compactitem}
\footnotesize
    \item This is a \urllink{https://www.ros.org/}{link}
